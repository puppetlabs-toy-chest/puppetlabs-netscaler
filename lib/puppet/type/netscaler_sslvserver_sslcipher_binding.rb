...
Puppet::Type.newtype(:netscaler_sslvserver_sslcipher_binding) do
  @doc = 'Configuration for SSL virtual server resource - binding with cipher.'

  apply_to_device
  ensurable

  newparam(:name, :parent => Puppet::Parameter::NetscalerName, :namevar => true)
  desc "This is the binding of sslvserver/cipher"
