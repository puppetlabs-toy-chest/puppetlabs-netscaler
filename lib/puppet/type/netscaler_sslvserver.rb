...
Puppet::Type.newtype(:netscaler_sslvserver) do
	@doc = 'Manage SSL VServer on the NetScaler appliance.'
...
Default value: ENABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:sessreuse, :parent => Puppet::Property::NetscalerTruthy) do
...
Default value: ENABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:cipherredirect, :parent => Puppet::Property::NetscalerTruthy) do
...
Default value: DISABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:sslv2redirect, :parent => Puppet::Property::NetscalerTruthy) do
...
Default value: DISABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:clientauth, :parent => Puppet::Property::NetscalerTruthy) do
...
Default value: DISABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:sslredirect, :parent => Puppet::Property::NetscalerTruthy) do
...
Default value: DISABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:redirectportrewrite, :parent => Puppet::Property::NetscalerTruthy) do
...
Default value: DISABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:nonfipsciphers, :parent => Puppet::Property::NetscalerTruthy) do
...
Default value: ENABLED", 'ENABLED', 'DISABLED')
	...
	newproperty(:snienable, :parent => Puppet::Property::NetscalerTruthy) do
...
Possible values: Always, Merge, Ignore, Timer"
	...
	newproperty(:sendclosenotify, :parent => Puppet::Property::NetscalerTruthy) do
...
Maximum value: 65534"
	...
	newproperty(:dh_keyexpsizelimit, :parent => Puppet::Property::NetscalerTruthy) do
